...
@section('title', 'Punto de Venta / Facturación POS')
...
<div class="pos-layout">
    ...
    <div>
        <div class="data-card pos-cart-panel" style="padding: 1rem;">
            ...
            <!-- EMIT INVOICE BUTTON -->
            <button type="button" id="btnEmitirFactura" class="btn-card-action btn-success" style="width: 100%; padding: 0.75rem; font-size: 1rem;" onclick="processInvoice()">
